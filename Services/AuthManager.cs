...
namespace Services
{
	public class AuthManager : IAuthService
	{
		...
		public IEnumerable<IdentityUser> GettAllUsers()
		{
		...
		public async Task<IdentityResult> ResetPassword(ResetPaswordDto model)
		{
		...
		public async Task<IdentityResult> UserDelete(string userName)
		{
			var user = await GetOneUser(userName);
